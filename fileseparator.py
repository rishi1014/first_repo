import os, shutil            #imported two modules that is os and shutil

#Suppose you have a file that have a lot of files like audio video document etc. Now you want to separate them in folders
dict_extensions = {
